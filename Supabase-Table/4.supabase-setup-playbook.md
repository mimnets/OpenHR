...
If you are getting errors about missing columns (e.g., `location`), run this script to repair your table structure:

```sql
-- Run this if you are missing specific columns
...
-- Notify PostgREST to refresh schema cache (IMPORTANT)
